...
- **[配置快速参考指南](QUICK_START_CONFIG.md)** - 5 分钟快速上手
- **[完整使用说明书](USER_GUIDE.md)** - 详细的配置指南和最佳实践

### 核心内容

1. **配置架构概览** - 理解配置文件的层次和关系
2. **一步步配置指南** - 从工具定义到决策矩阵的完整流程
3. **实战场景示例** - 防止保证性承诺、高额退款审核等场景
4. **配置验证和测试** - 如何验证配置正确性
5. **常见问题排查** - 配置不生效、决策不符合预期等问题
